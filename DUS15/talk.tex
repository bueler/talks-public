...
\item \emph{well-posedness}: are implicit time-steps well-posed?
    \begin{itemize}
    \item[$\circ$] explicit time steps are well-posed, but give severe stability time-step restrictions
    \end{itemize}
...
\begin{frame}{for conservation: subsets of $\Omega$}
