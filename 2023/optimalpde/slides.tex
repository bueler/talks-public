...
\begin{itemize}
\item $N=m_x m_y$
\item global ordering $k=0,1,\dots,N-1$
\item FIXME SPY PLOTs
\end{itemize}
\end{column}
\begin{column}{0.27\textwidth}
\hfill \includegraphics[width=0.9\textwidth]{images/gridordering.png}

\hfill \includegraphics[width=0.55\textwidth]{images/lapspy5.pdf}

\hfill \includegraphics[width=0.75\textwidth]{images/lapspy8.pdf}
