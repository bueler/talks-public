...
\medskip
\item Q: is $B^c \approx A^{-1}$?  \only<2>{\hspace{20mm} \alert{yes, for smooth inputs}}
\end{itemize}
\end{frame}
...
\item when faced with a coarse-grid solve, just do another 2-grid \dots and keep going down to some easy and cheap coarse grid
