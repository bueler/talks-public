...
\item this talk explains why you would want to use a big, complicated library of C codes to solve PDEs
\end{itemize}
\end{frame}
...
\item thus: a Krylov method is optimal if $m$ is bounded independently of $N$
\end{itemize}
\end{frame}
