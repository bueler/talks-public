...
\begin{itemize}
\item \dots \emph{but} in 2D and 3D the bandwidth grows as $h\to 0$
...
\item banded direct methods for PDE problems on structured grids with $m$ points in each direction:
	\begin{itemize}
...
\begin{itemize}
\item $\text{A New Hope in the 1970s}^{\includegraphics[width=0.06\textwidth]{figs/anewhope}}$ among numerical analysts, for FDM and FEM discretizations of a PDE, was to notice that
