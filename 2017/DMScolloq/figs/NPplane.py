...
for j in range(3):
    ...
    plt.text(2.5,-0.9,'$P$ = number of processors',fontsize=12.0)

    ax.arrow(0.0, -1.0, 0.0, 7.0, head_width=0.07, head_length=0.15, fc='k', ec='k')
    plt.text(-0.5,1.5,'$N$ = degrees of freedom',fontsize=12.0,rotation=90.0)
