...
\begin{itemize}
\item start with mesh generation using Gmsh (\href{http://gmsh.info/}{\alert{\texttt{gmsh.info}}})
...
\end{center}
    ...
    \vspace{-1mm}
    \begin{itemize}
    \item[$\circ$] 2004 FEM seminar used \href{https://popersson.github.io/distmesh/}{\alert{DistMesh}} in Matlab
    \end{itemize}
