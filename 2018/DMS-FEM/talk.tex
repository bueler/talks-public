...
\item \textbf{Example:} meshes with $N=7,18,55$ nodes
...
\item modern expectation: preconditioned Krylov methods
    \begin{itemize}
    ...
    \end{itemize}
\item a \emph{preconditioner} is a way of rapidly solving $M\bp=\bc$ where $M$ is spectrally-equivalent to $A$
\end{itemize}
\end{frame}
